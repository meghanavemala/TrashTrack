...
//import 'package:flutter_bluetooth_serial_example/trashtrackinitself/fitness_app_home_screen.dart';
...
class MyDiaryScreen extends StatefulWidget {
  ...
  static String routeName="/my_diary_screen";
...
class _MyDiaryScreenState extends State<MyDiaryScreen>
  ...
  void addAllListData() {
    ...
    listViews.add(
      TitleView(
        titleTxt: 'Manage Waste Effectively',
        subTxt: 'Details',
    ...
    listViews.add(
      Padding(
        ...
        child: ClipRRect(
          ...
          child: Image.asset(
            'assets/fitness_app/medit.png', // Assuming the image is in the assets folder
            fit: BoxFit.cover,
    ...
    listViews.add(
      InkWell(
        onTap: () {
          // Refresh the page by popping and pushing it again
          Navigator.of(context).pushReplacement(
            MaterialPageRoute(
              builder: (context) =>
                  const FitnessAppHomeScreen(), // Replace YourPage with your actual page
            ),
          );
        },
        child: TitleView(
